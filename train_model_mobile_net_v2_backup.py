...
model = keras.Model(inputs, outputs, name='crab_classifier')
...
# Debug: Check what's in history_phase2
print("\n🔍 DEBUG: Phase 2 history keys:", list(history_phase2.history.keys()))
print("🔍 DEBUG: Phase 2 history values:", {k: len(v) for k, v in history_phase2.history.items()})

# Handle empty phase 2 history
if 'accuracy' in history_phase2.history and len(history_phase2.history['accuracy']) > 0:
    ...
    phase2_epochs = 0
    # Create empty phase 2 history for compatibility
