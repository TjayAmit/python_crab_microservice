...
# CRITICAL: Use 224x224 for EfficientNetB0
IMAGE_SIZE = (224, 224)
BATCH_SIZE = 32
EPOCHS = 100
...
def load_and_preprocess_image(img_path, label):
    """Load image with proper EfficientNet preprocessing"""
    ...
    # EfficientNet expects values in [0, 255] range, then normalizes internally
...
# EfficientNet has ~237 layers, freeze bottom 80%
